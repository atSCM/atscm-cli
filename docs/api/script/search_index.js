window.esdocSearchIndex = [
  ...
  [
    ...
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber32",
    "RunCommand",
    "test"
  ],
  [
    "runcommand#run src/cli/commands/run.js~runcommand#run,runcommand#run",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber36",
    "RunCommand #run",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber44",
    "RunCommand #run should print tasks",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber61",
    "RunCommand #run should print tasks with `--tasks-json` flag",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber55",
    "RunCommand #run should print tasks with `--tasks-simple` flag",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber70",
    "RunCommand #run should print tasks with `--tasks` flag",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber76",
    "RunCommand #run should report unknown tasks",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber85",
    "RunCommand #run with defined tasks",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber86",
    "RunCommand #run with defined tasks should await returned promises",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber96",
    "RunCommand #run with defined tasks should report invalid task return types",
    "test"
  ],
  [
    "",
    "test-file/test/cli/commands/Run.spec.js.html#lineNumber91",
    "RunCommand #run with defined tasks should wait for streams to end",
    "test"
  ],
  [
  ...
  [
    "src/cli/commands/update.js~updatecommand#constructor",
    "class/src/cli/commands/Update.js~UpdateCommand.html#instance-constructor-constructor",
    "src/cli/commands/Update.js~UpdateCommand#constructor",
    "method"
  ],
  [
