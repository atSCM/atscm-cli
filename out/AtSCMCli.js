...
class AtSCMCli extends _liftoff.default {
  ...
  printVersion() {
    return this.getVersion().then(version => {
      _Logger.default.info('CLI version', _Logger.default.format.number(version.cli));

      if (version.local) {
        _Logger.default.info('Local version', _Logger.default.format.number(version.local));
      }
