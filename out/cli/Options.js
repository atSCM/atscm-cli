...
const Options = {
  ...
  debug: _Option2.default.boolean('Use debug mode.'),
  yes: _Option2.default.boolean('Use default values.', { alias: 'y' }),
  // NOTE: Commit once gulp is no longer required for running
  link: _Option2.default.boolean('Link atscm instead of installing. ' + 'This allows you to use you local atscm version. (Run `npm link .` first)')
};
